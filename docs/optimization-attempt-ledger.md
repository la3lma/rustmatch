...
|---:|---|---|---|---|---|
| 1 | [**FUTURE-ASSERT - Phase-resolved assertion construction recovery**](https://github.com/la3lma/rmatch-performance-measurements/blob/3de2e7c9cf957b7ffa859f46418c0864f8b85601/docs/lab-notebook/2026-07-28-post-h19-construction-phase-audit.md) | phase audit complete; no H20 source candidate authorized | H14-H19 repeatedly preserve roughly 185x-745x exact assertion scan gains, but the 13,500-build phase audit did not localize H19's preserved formal preparation penalty. Boundary-500 retained a smaller +5.394% diagnostic delta, boundary-1000 retained only +1.799%, and no single phase met the frozen scale and contribution rule. | Run a timer-free and allocator-free repeated-construction comparison of exact H11 and H19 artifacts. Escalate to binary-layout controls only if the uninstrumented lane reproduces a stable penalty; otherwise classify the one-build-per-process formal preparation delta as process or harness variance. | Very high narrow-workload scan reward, high mechanism confidence, low diagnostic cost, but low confidence that another source-level construction tweak can reach the 5% keeper threshold |
