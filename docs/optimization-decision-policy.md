...
**Current version:** `G9-v2`

**Effective for newly frozen experiments:** 2026-07-26
...
the production tree. No average gain, competitor comparison, or appealing
mechanism can offset a failed admission guard.
...
1. A repeatable guard regression greater than **3%** is an automatic veto for
   the exact candidate, regardless of gains elsewhere.
...
`B2-H-0009` remains rejected and unmerged under `G9-v1`. `G9-v2` adds the
