...
| Linux s390x (`s390x-unknown-linux-gnu`) | QEMU-emulated bounded semantic smoke passed ([31334450537](https://github.com/la3lma/rustmatch/actions/runs/31334450537)) | Best effort; non-blocking, non-native, and non-performance evidence |
