...
flowchart TB
    ...
    subgraph OPT[Optimization and scale]
        ...
        G6["HARD RUST PERFORMANCE GATE<br/>correctness parity + positive win beyond noise<br/>Java evidence does not count<br/>NOT STARTED"]
        I7["I7 Safe start acceleration and literal prefilter<br/>NOT STARTED"]
        G7["HARD RUST PERFORMANCE GATE<br/>correctness parity + positive win beyond noise<br/>Java evidence does not count<br/>NOT STARTED"]
        I8["I8 Parallel pattern partitions<br/>NOT STARTED"]
        G8["HARD RUST PERFORMANCE GATE<br/>correctness parity + positive win beyond noise<br/>Java evidence does not count<br/>NOT STARTED"]
    ...
    classDef gate fill:#ffe8cc,stroke:#d9480f,color:#431407,stroke-width:3px;
...
| Orange, `HARD RUST PERFORMANCE GATE` | The optimization cannot advance without correctness parity and a positive Rust result beyond noise |
...
| I6 | Lazy deterministic-state cache | Not started | Rust optimized/baseline event equality, cache-budget fallback evidence, and positive improvement beyond the predeclared noise gate; Java results only motivate candidates |
| I7 | Safe prefilter | Not started | Rust prefilter on/off event equality, adversarial safety fixtures, and positive improvement in the measured activation region; Java thresholds do not count |
| I8 | Parallel partitions | Not started | Event equality across worker counts, failure/deadlock tests, resource cleanup, complete thread sweep, and a positive Rust throughput result beyond noise |
