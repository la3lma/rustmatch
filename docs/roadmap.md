...
**Implementation increments started:** **4/12**

**Implementation increments complete:** **4/12**

**Active:** none

**Available for execution:** **I4 - repetition and longest-match semantics**
...
flowchart TB
    ...
    class P0,P1,P2,Q0,Q1,W0,I0,F0,A0,I1,I2,I3,C0,C1,B0,E0 complete;
    class I4 available;
    class X0,B1,H1,R1,R2 evidence;
    class S0,G6,G7,G8,I10,I11 gate;
    class I5,I6,I7,I8,I9,H2,H3,R3,REL planned;
...
| I4 | Repetition and longest match | Available | Exact overlap/ambiguity fixtures, quantifier binding, repetition limits, and Java event equality |
